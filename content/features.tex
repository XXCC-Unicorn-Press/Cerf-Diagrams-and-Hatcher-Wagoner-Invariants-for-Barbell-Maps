...
When the template repository is updated, you can use \verb|sync-template| CLI tool to synchronize the changes.
See \url{https://github.com/XXCC-Unicorn-Press/sync-template} for more details on how to use this tool.
The following files and directories will be ignored during the synchronization process, to avoid overwriting your content:
\begin{itemize}
  \item \verb|content/|
  \item \verb|figures/|
